...
Comenzaremos por establecer una estructura de directorios para nuestros archivos. Puedes descargar el directorio completo de CETEIcean en Github aquí y trabajar en la carpeta "tutorial_es", o puedes reproducir la estructura de esa carpeta en tu computadora para guardar los archivos. El resultado debería tener la siguiente forma:
